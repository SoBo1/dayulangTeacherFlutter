...
class HttpDYL2 {
  ...
  // post 请求
  Future post(url, {pathParams, params, needCode = false, cancelToken}) async {
    return await request(
        url, pathParams, params, 'POST', null, needCode, cancelToken);
  }

  // put 请求
  Future put(url, {pathParams, params, needCode = false, cancelToken}) async {
    return await request(
        url, pathParams, params, 'PUT', null, needCode, cancelToken);
  }

  // delete 请求
  Future delete(urlName,
      {pathParams, params, needCode = false, cancelToken}) async {
    return await request(
  ...
  /*
        ...
        * @return {type}   返回响应数据
        */
  //   Future rc_requset(String url,{String method = "GET",required Map<String,dynamic> params}) async{
  ...
  //   }
  // }
  Future request(urlName, pathParams, params, method, header, needCode,
      cancelToken) async {
